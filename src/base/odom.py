...
class Odom():
    WHEEL_DISTANCE = rospy.get_param('~wheel_distance', 0.273)
    WHEEL_DIAMETER = rospy.get_param('~wheel_diameter', 0.195)
    COUNTS_PER_REVOLUTION = rospy.get_param('~caunts_per_revolution', 51375)
	...
	# velocities
        v_right = enc_msg.data[0] * Odom.DISTANCE_PER_COUNT / deltaTime 
        v_left = enc_msg.data[1] * Odom.DISTANCE_PER_COUNT / deltaTime 
